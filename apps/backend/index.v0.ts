import { authRouter as v0AuthRouter } from "@/v0/auth/routes";
import { chatRouter as v0ChatRouter } from "@/v0/chat/routes";
...
app.use("/v1/auth", v0AuthRouter);
app.use("/v1/chat", v0ChatRouter);
